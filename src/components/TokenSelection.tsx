...
const TokenSelection = () => {
  ...
  return (
    <div className="bg-gray-800 min-h-screen pt-8">
          ...
          <div className="space-y-6">
            <div>
              <input
                ...
                className="w-full px-4 py-4 bg-gray-600 border border-gray-500 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                maxLength={44}
              />
            </div>
