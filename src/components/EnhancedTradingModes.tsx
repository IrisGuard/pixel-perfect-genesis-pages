  ...
  return (
    <div className="w-full px-2 pb-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {/* Enhanced Independent Mode */}
        <div style={{backgroundColor: '#2D3748', border: '2px solid #9F7AEA'}} className="rounded-xl p-4">
        ...
        <div style={{backgroundColor: '#2D3748', border: '1px solid #4A5568'}} className="rounded-xl p-4">
          ...
          <div className="space-y-2 mb-4">
            <div className="flex items-center text-xs text-gray-300">
              <CheckCircle className="text-blue-400 mr-2" size={14} />
          ...
          <Button variant="outline" className="w-full border-blue-500 text-blue-400 hover:bg-blue-600 hover:text-white text-sm py-2">
