    ...
    <div className="w-full px-6 py-8" style={{backgroundColor: '#1A202C'}}>
      ...
      >
          ...
          <div className="lg:col-span-1">
            ...
            >
              ...
              <div className="mb-8">
                ...
                <div className="text-gray-500 text-sm mb-4">$SMBOT available</div>
              ...
              {/* APY Info */}
              <div className="mt-8 pt-6" style={{borderTop: '1px solid #4A5568'}}>
        ...
        <div className="mt-8 text-center">
          <div className="inline-flex items-center px-6 py-3 rounded-lg" style={{backgroundColor: '#1A202C', border: '1px solid #4A5568'}}>
            <span className="text-sm text-gray-300">
              💡 Staking rewards are distributed daily. Unstaking has a 7-day cooldown period.
            </span>
          </div>
        </div>
      </div>
