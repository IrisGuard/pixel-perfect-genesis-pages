  ...
  return (
    <div className="w-full px-6 py-8" style={{backgroundColor: '#1A202C'}}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-7xl mx-auto mb-8">
        {/* Your Stake */}
        <div 
          className="p-6 rounded-lg flex flex-col justify-center h-32"
          style={{
        ...
        >
          ...
          <div className="text-xl font-bold text-white mb-1 truncate">15,678,901.23</div>
          <div className="text-gray-500 text-sm">$SMBOT</div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-7xl mx-auto">
        ...
        {/* Your Balance */}
        <div 
          className="p-6 rounded-lg h-32 flex flex-col justify-center"
          style={{
            backgroundColor: '#2D3748',
            border: '1px solid #4A5568'
          }}
        >
          <div className="text-center">
            ...
            <div className="text-xl font-bold text-white mb-1">5,678.90</div>
            <div className="text-gray-500 text-xs mb-1">$SMBOT available</div>
